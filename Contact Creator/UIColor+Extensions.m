...
+ (CAGradientLayer *) gradientType:(NSInteger) gType frameRectangle:(CGRect) fRect {
    if (gType == 0) { //yammer blue
        
    CAGradientLayer *yammerBlueGradient = [CAGradientLayer layer];
        yammerBlueGradient.name = @"blueGradient";
        yammerBlueGradient.frame = fRect;
        UIColor* yammerBlueTopGradient = [UIColor colorWithRed:130.0f/255.0f green:193.0f/255.0f blue:224.0f/255.0f alpha:1.0f];
        UIColor* yammerBlueBottomGradient = [UIColor colorWithRed:51.0f/255.0f green:153.0f/255.0f blue:204.0f/255.0f alpha:1.0f];
        NSMutableArray *yammerBlueGradientLocations = [NSArray arrayWithObjects:
                                                       [NSNumber numberWithFloat:0.0], [NSNumber numberWithFloat:0.2], nil];
        yammerBlueGradient.colors = [NSArray arrayWithObjects:(id)[yammerBlueTopGradient CGColor], (id)[yammerBlueBottomGradient CGColor], nil];
        yammerBlueGradient.locations = yammerBlueGradientLocations;
        
        return yammerBlueGradient;
    }
    else if (gType == 1) //yammer green
    {
        CAGradientLayer *yammerGreenGradient = [CAGradientLayer layer];
        yammerGreenGradient.name = @"greenGradient";
        yammerGreenGradient.frame = fRect;
        UIColor* yammerGreenTopGradient = [UIColor colorWithRed:170.0f/255.0f green:238.0f/255.0f blue:55.0f/255.0f alpha:1.0f];
        UIColor* yammerGreenMiddleGradient = [UIColor colorWithRed:130.0f/255.0f green:219.0f/255.0f blue:53.0f/255.0f alpha:1.0f];
            UIColor* yammerGreenBottomGradient = [UIColor colorWithRed:100.0f/255.0f green:173.0f/255.0f blue:85.0f/255.0f alpha:1.0f];
        NSMutableArray *yammerGreenGradientLocations = [NSArray arrayWithObjects:
                                                       [NSNumber numberWithFloat:0.0],
                                                        [NSNumber numberWithFloat:0.3],
                                                        [NSNumber numberWithFloat:0.8], nil];
        yammerGreenGradient.colors = [NSArray arrayWithObjects:(id)[yammerGreenTopGradient CGColor], (id)[yammerGreenMiddleGradient CGColor],(id)[yammerGreenBottomGradient CGColor], nil];
        yammerGreenGradient.locations = yammerGreenGradientLocations;
        return yammerGreenGradient;
        
    }
    if (gType == 2) { //yammer grey
        
        CAGradientLayer *yammerGreyGradient = [CAGradientLayer layer];
        yammerGreyGradient.name = @"greyGradient";
        yammerGreyGradient.frame = fRect;
        UIColor* yammerGreyTopGradient = [UIColor colorWithRed:211.0f/255.0f green:211.0f/255.0f blue:211.0f/255.0f alpha:1.0f];
        UIColor* yammerGreyBottomGradient = [UIColor colorWithRed:151.0f/255.0f green:151.0f/255.0f blue:151.0f/255.0f alpha:1.0f];
        NSMutableArray *yammerGreyGradientLocations = [NSArray arrayWithObjects:
                                                       [NSNumber numberWithFloat:0.0],
                                                       [NSNumber numberWithFloat:0.6], nil];
        yammerGreyGradient.colors = [NSArray arrayWithObjects:(id)[yammerGreyTopGradient CGColor], (id)[yammerGreyBottomGradient CGColor], nil];
        yammerGreyGradient.locations = yammerGreyGradientLocations;
        return yammerGreyGradient;
    }
    else
    {
        return nil;
